...
- **指定 integration 上的本地领域 Edge 启动已形成受测候选**：OS
  ...
  10 图、ready 窗口 browser error 与 HTTP 4xx/5xx 为 0；当前未 merge/push/pin，
  只属于 testing candidate；
