...
service port 和 UI1B 原 UI/controller + 真实 OS happy path 已完成，下一 Runtime 顺序是
UI1C feedback/fault/restart hardening → UI1D 旧接口退役/最终真实 OS gate → Core #152
