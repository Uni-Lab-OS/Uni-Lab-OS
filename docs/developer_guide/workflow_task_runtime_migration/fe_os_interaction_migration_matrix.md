...
feedback/fault/restart hardening 和 UI1D 退役/final gate/exact-SHA review 已完成，下一
Runtime 顺序是 Core #152 发布/Feishu stage 对齐 → R2；R2 仍依赖 A1、I1、C1 和 M1
