...
- **指定 integration 上的本地领域 Edge 启动已形成受测候选**：OS
  ...
  只属于 testing；
- **F007 Edge/runtime safety 已形成受测候选**：OS
  ...
  Standards `0B/0NB`、Spec `0B/0NB`；候选尚未 merge/Core pin，不等于 accepted；
