...
- **联调进度**：R1B、UI1A、UI1B 和 UI1C 均有本地候选 full SHA；UI1B 已通过独立真实
  ...
  spec 应在 UI1D 开始前写入 `Uni-Lab-OS/Uni-Lab-Core#152`；UI1C fault/restart
