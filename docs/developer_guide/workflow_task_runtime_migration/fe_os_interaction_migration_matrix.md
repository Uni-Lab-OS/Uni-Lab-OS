...
- **D1A-S1 单 Action 正式 Task/Job 已形成最终受测跨仓候选**：Core #162 冻结
  ...
  旧 Run route 和 system source read 均为 0。软件已通过 exact-SHA review 并以 OS
  integration `25e71d1`、canonical dev `b3190ca8`、FE integration `b963a33d`、Core
  pin/evidence `68768e5` 发布；当前只待物理设备/ROS 与 Feishu acceptance，
