...
|---|---|---|---:|---|
| Backend Workflow/Task Interface | documents 10-12 | semantic | 01 | mirror existing Backend names; explicitly specify additions |
...
| Source `DagWalk` control semantics | `4ec146f` | semantic | 03 | port branch/join/start/skip behavior, not mutable EdgeState |
...
| Source cancel/unknown/reconcile | `4ec146f`, `a80314f` | semantic | 04 | preserve physical uncertainty fences |
...
| Source local bridge | `4ec146f`, `a80314f` | semantic | 01/02/04/05 | do not retain Run routes or old field names |
| Frontend authoring/runtime/debugger | `2efb442` | semantic | 08 | switch directly to WorkflowTask Interface |
| Cloud Adapter | supplemental protocol | semantic | 08 | exact scope deferred to phase entry |
